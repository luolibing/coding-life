package cn.tim.multirep.second.entity;
...
public class Teacher {
    ...
    @ManyToOne(targetEntity = cn.tim.multirep.second.entity.School.class,fetch = FetchType.LAZY)
    @JoinColumn(name="school_id")
    private cn.tim.multirep.second.entity.School school;
    ...
    public cn.tim.multirep.second.entity.School getSchool() {
        return school;
    }

    public void setSchool(cn.tim.multirep.second.entity.School school) {
        this.school = school;
    }
