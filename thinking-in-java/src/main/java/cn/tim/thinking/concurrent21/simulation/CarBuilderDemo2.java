package cn.tim.thinking.concurrent21.simulation;
...
public class CarBuilderDemo2 {
    ...
    //
    static class ExhaustSystemRobot extends Robot {
        ...
        @Override
        protected void performService() {
            System.out.println(this + " add exhaustSystem");
    ...
    static class BodyRobot extends Robot {
        ...
        @Override
        protected void performService() {
            System.out.println(this + " add body");
            assembler.car.addBody();
        }
    }

    static class FenderRobot extends Robot {
        ...
        @Override
        protected void performService() {
            System.out.println(this + " add fender");
